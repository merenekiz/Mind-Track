      ...
      <div className="flex-1 flex items-center justify-center relative" style={{ padding: "64px 32px" }}>
        ...
        <div className="w-full animate-fade-in" style={{ maxWidth: 420 }}>
          ...
          <div style={{ marginBottom: 48 }}>
            <h2 style={{ fontSize: 32, fontWeight: 700, lineHeight: 1.1 }}>Giriş Yap</h2>
            <p className="text-mt-muted" style={{ fontSize: 15, marginTop: 12, lineHeight: 1.6 }}>Hesabınıza giriş yaparak devam edin</p>
          </div>
          ...
          <p className="text-center text-mt-muted" style={{ fontSize: 14, marginTop: 48 }}>
            Hesabınız yok mu?{" "}
            <Link href="/register" className="text-mt-accent font-semibold hover:underline">
              Kayıt Ol
            </Link>
          </p>
        </div>
